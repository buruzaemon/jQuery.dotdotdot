...
{var tmp=[];for(var i=0,l=tArr.length;i<l;i++){tmp.push(tArr[i]);if(i<l-1){var c1=fixedCharCodeAt(tArr[i],tArr[i].length-1);var c2=fixedCharCodeAt(tArr[i+1],0);if!(isJaCharCode(c1)||isJaCharCode(c2)){tmp.push(' ');}}}
return tmp.join('');}
